...
var MENU_LEVEL: PackedScene = load("res://ui/menus/menu_level.tscn") # preload causes error when loaded from menus for some unknown reasonn
...
#var RATING: Array[Texture2D] = [RATING_0, RATING_1, RATING_2, RATING_3, RATING_4, RATING_5]
var RATING: Array[Texture2D] = [
		preload("res://resources/sprites/reaper/star_rating_0.png"), 
		preload("res://resources/sprites/reaper/star_rating_1.png"),
		preload("res://resources/sprites/reaper/star_rating_2.png"),
		preload("res://resources/sprites/reaper/star_rating_3.png"),
		preload("res://resources/sprites/reaper/star_rating_4.png"),
		preload("res://resources/sprites/reaper/star_rating_5.png"),
		]
...
var levels: Array = [
	LevelData.new("first steps", [3,4,5,7,9], load("res://levels/tutorial.tscn")), # again preload is causing problems
